...
![Enzyme table example](docs/protocol_developer/images/table_images/1-enzyme_table.png)
...
![Simple table example](docs/protocol_developer/images/table_images/2_simple_table-1.png)
...
![Simple table example](docs/protocol_developer/images/table_images/3_simple_table-2.png)
...
![Simple table example](docs/protocol_developer/images/table_images/4_simple_table-3.png)
...
![Simple table example](docs/protocol_developer/images/table_images/5_simple_table-4.png)
...
![Simple table example](docs/protocol_developer/images/table_images/6_simple_table-5.png)
...
![Input table example](docs/protocol_developer/images/table_images/7_input_table-1.png)
...
![Input table example](docs/protocol_developer/images/table_images/8_input_table-2.png)

Then our parrot `Table` on the next slide would show

![Input table example](docs/protocol_developer/images/table_images/9_input_table-3.png)
...
![Standalone table example](docs/protocol_developer/images/table_images/10_standalone_table.png)
...
![Collection table example](docs/protocol_developer/images/table_images/11_collection_table.png)
