...
Choose the container you want, and a new item will be made.
...
This does not remove its information from the database and the item can be later restored if so desired.
